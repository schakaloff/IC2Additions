...
import com.ic2additions.config.ConfigEntryEnergyStorage;
...
public class TileEntityEnergyStorageBase extends TileEntityInventory implements IHasGui, IEnergyStorage {
    ...
    protected static final ResourceLocation GUILOC = new ResourceLocation(Reference.MODID, "guidef/energy_storage.xml");
    ...
    public String getStorageText() {
        return Localization.translate("ic2additions:gui.text.storageLong", (long) energy.getEnergy());
    }

    public String getCapacityText() {
        return Localization.translate("ic2additions:gui.text.capacity", (long) energy.getCapacity());
    }

    public String getOutputText() {
        return Localization.translate("ic2additions:gui.text.output", output);
    }
}