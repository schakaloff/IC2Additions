...
public class AdvancedElectricJetpack extends ItemArmorElectric implements IBoostingJetpack {
    ...
    public AdvancedElectricJetpack(String name) {
        this(name, 3_000_000.0, 30_000.0, 3);
    }

    public AdvancedElectricJetpack(String name, double maxCharge, double transferLimit, int tier) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return "ic2additions:textures/armor/" + name + ".png";
    }
