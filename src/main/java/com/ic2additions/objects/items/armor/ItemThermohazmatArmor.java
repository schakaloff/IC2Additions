...
public class ItemThermohazmatArmor extends ItemArmor implements IHazmatLike {
    public static final ArmorMaterial THERMO_HAZMAT = EnumHelper.addArmorMaterial(
            "THERMO_HAZMAT",
            "ic2additions:thermo_hazmat",
            5,
            new int[]{1, 2, 3, 1},
            12,
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add("  " + TextFormatting.GREEN + I18n.format("tooltip.ic2additions.radiation_protection"));
