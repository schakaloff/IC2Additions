...
public class ItemAdvancedQuantumArmor extends ItemArmorElectric
    ...
    public ItemAdvancedQuantumArmor(String name, EntityEquipmentSlot armorType) {
        super(null, "advanced_quantum_suit", armorType, MAX_CHARGE, TRANSFER, TIER);
    ...
    // ——— Removed all colour/dye APIs from Quantum (hasColor/removeColor/getColor/setColor/getDisplayNbt) ———

    // Textures like your Nano example.
    @Override
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return "ic2additions:textures/armor/advanced_quantum_" + (slot == EntityEquipmentSlot.LEGS ? "2" : "1") + ".png";
    }

    // Protection behavior unchanged from Quantum
    @Override
